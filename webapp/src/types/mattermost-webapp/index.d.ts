...
interface PluginRegistry {
    ...
    registerRightHandSidebarComponent(component: () => React.JSX.Element, title: string | React.JSX.Element)
    registerChannelHeaderButtonAction(icon: React.JSX.Element, action: () => void, dropdownText: string | null, tooltipText: string | null)
