...
export interface PluginRegistry {
    ...
    registerSlashCommandWillBePostedHook(hook: (message: string, contextArgs: MmHookArgTypes) => Promise<{message: string; args: MmHookArgTypes;}> | {message: string; args: MmHookArgTypes;})
